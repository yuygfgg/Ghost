...
def export_content(session: Session, repo: SiteRepo) -> list[dict]:
    ...
    for resource in resources:
        ...
        front_matter = {
            ...
            "total_size_bytes": public.get("total_size_bytes"),
            "total_size_human": public.get("total_size_human"),
            "file_count": public.get("file_count"),
            "files_tree_summary": public.get("files_tree_summary"),
            "files_tree": public.get("files_tree"),
            "tags": public["tags"],
